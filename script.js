...
function showBookDetails(book) {
    ...
    bookDetails.innerHTML = `
        ...
        // <a href="${bookInfo.previewLink}" target="_blank">Read this book</a>
    `;
...
// // Function to animate alphabets flying up
// function animateAlphabets() {
...
//         span.style.left = `${searchContainer.offsetLeft + index * 20}px`;
//         span.style.top = `${searchContainer.offsetTop}px`;
